...
while($entry = $result->fetch_object()) {
    ...
    if($entry->is_demo) {
        $youtube_id_extra .= '<span class="text-muted" data-toggle="tooltip" title="' . $language->youtube->admin_users_management->tooltip->demo . '"><i class="fa fa-fw fa-adjust fa-sm"></i></span>&nbsp;';
    }
