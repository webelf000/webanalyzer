...
if($type && $type == 'delete') {
    ...
    if(empty($_SESSION['error'])) {
        ...
        $database->query("DELETE FROM `youtube_videos` WHERE `youtube_user_id` = {$youtube_user_id}");
        ...
        $database->query("DELETE FROM `email_reports` WHERE `source_user_id` = '{$youtube_user_id}' AND `source` = 'YOUTUBE'");
